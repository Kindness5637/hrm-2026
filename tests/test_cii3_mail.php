 ...
 * Run from the HRM root: cd /home/kindness/Desktop/hrm./hrm && php tests/test_cii3_mail.php
 */

// Run from HRM root directory
...
echo "From: {$from}\n";
echo "Password decrypted OK: " . (strlen($pwd) > 0 ? 'YES (' . strlen($pwd) . ' chars)' : 'NO') . "\n";
