    ...
    public function ticket_list()
     {
		...
		if(!is_null($employee)){
			...
			if($employee[0]->profile_picture!='' && $employee[0]->profile_picture!='no file') {
				$de_file = base_url().'uploads/profile/'.$employee[0]->profile_picture;
				$de_file = '<span class="user-block"><img class="img-circle img-bordered-sm" src="'.base_url().'uploads/profile/'.$employee[0]->profile_picture.'" alt=""></span>';
			} else {
				if($employee[0]->gender=='Male') {
					$de_file = '<span class="user-block"><img class="img-circle img-bordered-sm" src="'.base_url().'uploads/profile/default_male.jpg" alt=""></span>';
				} else {
					$de_file = '<span class="user-block"><img class="img-circle img-bordered-sm" src="'.base_url().'uploads/profile/default_female.jpg" alt=""></span>';
				}
			}
		} else {
			$employee_name = '--';	
		...
		$iemployee_name = $de_file.$employee_name.' <small class="text-muted"><i>('.$company.')<i></i></i></small>';
