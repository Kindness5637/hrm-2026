    ...
    public function announcement_list()
     {
		...
		$ititle = $r->title.'<br><small class="text-muted"><i>'.$this->lang->line('xin_published_for').': '.$department_name.'<i></i></i></small><br><small class="text-muted"><i>'.$r->summary.'<i></i></i></small>';
		$data[] = array(
			$combhr,
			$ititle,
			$comp_name,
