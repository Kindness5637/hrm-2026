...
<section class="sidebar">
  ...
  <ul class="sidebar-menu" data-widget="tree">
      ...
      <ul class="treeview-menu">
        ...
        <?php } ?>
						...
						<?php if(in_array('312',$role_resources_ids)) { ?>
							<li class="sidenav-link <?php if(!empty($arr_mod['leave_active']))echo $arr_mod['leave_active'];?>"> <a href="<?php echo site_url('admin/timesheet/reconcile_leave');?>"> <i class="fa <?php echo $submenuicon;?>"></i> <?php echo $this->lang->line('xin_reconcile_leave');?> </a> </li>
    ...
    <?php  if(in_array('44',$role_resources_ids) || in_array('45',$role_resources_ids) || in_array('104',$role_resources_ids) || in_array('119',$role_resources_ids) || in_array('121',$role_resources_ids) || in_array('122',$role_resources_ids) || in_array('330',$role_resources_ids)) {?>
    ...
    <li class="<?php if(!empty($arr_mod['system_open']))echo $arr_mod['system_open'];?> treeview"> <a href="#"> <i class="fa fa-cog"></i> <span><?php echo $this->lang->line('xin_system');?></span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
      <ul class="treeview-menu">
        ...
        <?php } ?>
        <li class="sidenav-link <?php if(!empty($arr_mod['notification_center_active']))echo $arr_mod['notification_center_active'];?>"> <a href="<?php echo site_url('admin/settings/notification_center');?>"> <i class="fa fa-bell-o"></i> Notification Center </a> </li>
      </ul>
    </li>
    <?php } ?>
    <li> &nbsp; </li>
