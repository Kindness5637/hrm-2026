...
<body class="hold-transition login-page" style="background-position: center center; background-size: cover; background-color: #ffffff;">
<div class="login-box animated fadeInDownBig"> 
  ...
  <div class="login-box-body">
	...
	if($system[0]->employee_login_id=='username'):
		...
		$ilogn_info = 'administrator@stalis.co.ke';
