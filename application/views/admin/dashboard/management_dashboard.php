...
$designation_name = !is_null($designation) ? $designation[0]->designation_name : '--';
$role_user = $this->Xin_model->read_user_role_info($user_info[0]->user_role_id);
$role_resources_ids = !is_null($role_user) ? explode(',',$role_user[0]->role_resources) : explode(',',0);
?>
<?php $get_animate = $this->Xin_model->get_content_animate();?>

<div class="box-widget widget-user-2">
  <div class="widget-user-header">
    <h4 class="widget-user-username welcome-hrsale-user"><?php echo $this->lang->line('xin_title_wcb');?>, <?php echo $user_info[0]->first_name.' '.$user_info[0]->last_name;?>!</h4>
    ...
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a href="<?php echo site_url('admin/warnings');?>"> <?php echo $this->lang->line('left_warnings');?> <small><?php echo $this->lang->line('xin_performance_management');?></small></a></b></h5>
                    <small class="text-muted"><?php echo $this->lang->line('xin_hr_view_warnings');?></small>
                </div>
            </div>
        </div>
    </div>
    <div class="col-sm-6 col-lg-3">
        <div class="card p-3">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <h5 class="mb-1"><b><a href="<?php echo site_url('admin/timesheet/attendance');?>"> <?php echo $this->lang->line('dashboard_attendance');?> <small><?php echo $this->lang->line('xin_performance_management');?></small></a></b></h5>
                    <small class="text-muted"><?php echo $this->lang->line('xin_hr_view_attendance');?></small>
                </div>
            </div>
        </div>
    </div>
...
$abs = $total - $working;
$emp_abs = ($total > 0) ? $abs / $total * 100 : 0;
$emp_work = ($total > 0) ? $working / $total * 100 : 0;
?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
					...
					if($proj < 1) { $proj_percnt = 0; } else { $proj_percnt = $completed_proj / $proj * 100; }
					?>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between">
					...
					if($task_all < 1) { $task_percnt = 0; } else { $task_percnt = $completed_tasks / $task_all * 100; }
                    ?>
...
<div class="row <?php echo $get_animate;?>">
  <div class="col-md-6">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-users text-info"></i> <?php echo $this->lang->line('xin_employee_department_txt');?></h3>
      </div>
      <div class="box-body">
        <div class="box-block">
          <div class="col-md-7">
            <div class="overflow-scrolls" style="overflow:auto; height:200px;">
              <div class="table-responsive">
                <table class="table mb-0 table-dashboard">
                  <tbody>
                    <?php $c_color = array('#00A5A8','#FF4558','#16D39A','#8A2BE2','#D2691E','#6495ED','#DC143C','#006400','#556B2F','#9932CC','#00A5A8','#FF4558','#16D39A','#8A2BE2','#D2691E','#6495ED','#DC143C','#006400','#556B2F','#9932CC','#00A5A8','#FF4558','#16D39A','#8A2BE2','#D2691E','#6495ED','#DC143C','#006400','#556B2F','#9932CC');?>
  ...
  <div class="col-md-6">
    <div class="box">
      <div class="box-header with-border">
        <h3 class="box-title"><i class="fa fa-briefcase text-warning"></i> <?php echo $this->lang->line('xin_employee_designation_txt');?></h3>
      </div>
      <div class="box-body">
        <div class="box-block">
          <div class="col-md-7">
            <div class="overflow-scrolls" style="overflow:auto; height:200px;">
              <div class="table-responsive">
                <table class="table mb-0 table-dashboard">
                  <tbody>
                    <?php $c_color2 = array('#9932CC','#556B2F','#16D39A','#DC143C','#D2691E','#8A2BE2','#FF976A','#FF4558','#00A5A8','#6495ED','#9932CC','#556B2F','#16D39A','#DC143C','#D2691E','#8A2BE2','#FF976A','#FF4558','#00A5A8','#6495ED');?>
...
<div class="row <?php echo $get_animate;?>">
  <div class="col-md-12">
    <div class="card full-height">
      <div class="card-body">
        <div class="card-title"><i class="fa fa-money text-success"></i> <?php echo $this->lang->line('xin_hrsale_paid_salaries_account_balances');?></div>
